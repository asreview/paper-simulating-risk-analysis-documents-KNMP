...
asreview simulate simulations/data/output/clopidogrel_sim2.csv -s simulations/output/${DATA}/simulation/run_${DATA}_${RUN}.h5 --prior_idx $PRIOR_IDX -m logistic --seed $SEED
