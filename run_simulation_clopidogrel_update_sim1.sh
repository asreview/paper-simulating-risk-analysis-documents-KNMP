...
asreview simulate simulations/data/output/asreview_result_clopidogrel-search2-recoded.csv -s simulations/output/${DATA}/simulation/run_${DATA}_${RUN}.h5 --prior_idx $PRIOR_IDX -m logistic --seed $SEED
